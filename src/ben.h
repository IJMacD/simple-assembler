 ...
 *****************/
//           |0      7       F0      7       F|
#define HT  0b10000000000000000000000000000000  // Halt clock
...
#define DR  0b00000000000000010000000000000000  // Decoder reset (T-state)
#define I1  0b00000000000000001000000000000000  // Input 1 in
#define I2  0b00000000000000000100000000000000  // Input 2 in
#define LA  0b00000000000000000010000000000000  // Logical AND
#define LO  0b00000000000000000001000000000000  // Logical OR
#define LX  0b00000000000000000000100000000000  // Logical XOR
#define TI  0b00000000000000000000010000000000  // TMP Register in
#define TO  0b00000000000000000000001000000000  // TMP Register out
#define BO  0b00000000000000000000000100000000  // B register out
#define CI  0b00000000000000000000000010000000  // C register in
#define CO  0b00000000000000000000000001000000  // C register out
 ...
 * ALU Flags
 ************/
#define ALU_FLAG_S  0b10000000
#define ALU_FLAG_Z  0b01000000
